...
/// This class should contain all configuration necessary to build an app that is
/// based on the inFLUX template. [It will get generated at a later devel stage!]
class InFluxConfig {
  // styling:
