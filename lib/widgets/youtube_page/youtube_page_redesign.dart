...
class YoutubePageRedesign extends StatefulWidget {
  final YoutubeApiAdapter apiAdapter;

  YoutubePageRedesign({this.apiAdapter, Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() =>
      _YoutubePageRedesignState(youtubeApiAdapter: this.apiAdapter);
}

class _YoutubePageRedesignState extends State<YoutubePageRedesign> {
  ...
  _YoutubePageRedesignState({YoutubeApiAdapter youtubeApiAdapter})
