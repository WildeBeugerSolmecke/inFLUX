        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(12.0),
                child: Image.network(this.videoInfo.thumbnailUrls[ThumbnailSize.LARGE], fit: BoxFit.contain),
              ),
            ),
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ClipOval(
                    child: Image.network(this.channelInfo.thumbnailUrls[ThumbnailSize.MEDIUM], width: 90, height: 90)
                  ),
                  SizedBox(width: 10.0),
                  Expanded(
                    child: Column(
